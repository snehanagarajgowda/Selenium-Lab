...
public class Lab5_Part4 {
    ...
    public static void main(String[] args) {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("input-firstname"))).sendKeys("Sneha");
        System.out.println("Entered First Name: Sneha");

        driver.findElement(By.id("input-lastname")).sendKeys("N");
        System.out.println("Entered Last Name: N");

        String email = "snehanagaraj9632@gmail.com";
        driver.findElement(By.id("input-email")).sendKeys(email);
        System.out.println("Entered Email: " + email);

        driver.findElement(By.id("input-telephone")).sendKeys("8890245677");
        System.out.println("Entered Telephone: 8890245677");

        driver.findElement(By.id("input-password")).sendKeys("Sneha@123");
        System.out.println("Entered Password:Sneha@123");

        driver.findElement(By.id("input-confirm")).sendKeys("Sneha@123");
        System.out.println("Entered Confirm Password:Sneha@123");
